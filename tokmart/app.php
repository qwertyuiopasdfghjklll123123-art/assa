<?php
/**
 * Main application shell: the Tokmart single-page storefront (+ in-app admin overlay).
 * All data comes from api/index.php via callAPI(); this file only renders the shell
 * and injects the handful of values the frontend needs before it can call the API
 * (login state, enabled payment methods, Google client id) through window.APP_CONFIG.
 */
